...
export function CallToAction() {
  ...
  return (
    <section className="py-16 sm:py-20 md:py-28 lg:py-32 relative overflow-hidden">
      {/* Background gradient */}
      <div className="absolute inset-0 bg-gradient-to-b from-[#0a0a0a] via-[#1a1a2e]/30 to-[#0a0a0a] pointer-events-none" />
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          {/* Decorative border */}
          <div className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-[#915eff] to-transparent" />
        </motion.div>
      </div>
    </section>
  )
